...
class Sound{
    ...
    play(freq){
        ...
        this.vel.gain.setValueAtTime(.2,this.context.currentTime);
    ...
    stop(){
        this.vel.gain.linearRampToValueAtTime(0.001,this.context.currentTime+.1);
        // this.lpf.frequency.linearRampToValueAtTime(0.001,this.context.currentTime+.5);
        this.osc.stop(this.context.currentTime+.15);
    }
}
...
//chord note data
var chords = [
    [261.63,0,0,0,0,0,0,0,440.00,0,0,0,0,0,0,0],
    [329.63,0,0,0,0,0,0,0,349.23,0,0,0,0,0,0,0],
    [392.00,0,0,0,0,0,0,0,440.00,0,0,0,0,0,0,0],
    [261.63/2,0,261.63/2,0,261.63/2,0,261.63/2,0,293.66/2,0,293.66/2,0,293.66/2,0,293.66/2,0]
]
//sequencer state
var running = false;
var hasLooped = false;
...
setInterval(function(){
    ...
    if(timer>=beat){
        ...
        //goes through every note in the chord sequence and plays the corresponding note
        chords.forEach(function(note){
            // playSound(note[step]);
